...
- installed-app automation completes onboarding, posting, editing, replying, voting, Revisit, Open Nostr, settings, Reddit Bridge guardrails, and export import;
- secrets, app state, private roadmap material, and deferred surfaces are absent from tracked files and history;
